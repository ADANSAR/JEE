...
## Fonctionnalités :
	...
	--> Enlèvement d'un ou plusieurs livres au panier électronique.
	...
	--> Recherche d'un livre avec une partie de son titre, ou même avec un mot avec des accents ressemblant à un morceau du titre du livre.

	--> Affichage de tous les livres d'un auteur.

	--> Trie des livres par année de parution.

	--> Affichages des anciennes commandes passé par le client.
	
## Conclusion :

	Dans ce projet on pris les differentes possibilité technologies qui qont offerts par JEE.
	
	Ainsi se projet présent tout les possibilité proposé pour faire le developpement d'une application JEE.
