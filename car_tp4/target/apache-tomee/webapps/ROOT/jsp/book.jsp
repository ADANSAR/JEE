...
<html>
    ...
    <body>
        ...
        <a href="/Init">Initialiser les livres</a></br>
        ...
        <a href="/Commandes">afficher les commandes récentes</a><br/>
        ...
        <form method="POST" action="/ChercheLivreParAuteur">
            Nom d'Auteur<br/><input type="text" name="auteur"/>
            <br/>
            <input type="submit" value="Chercher les livres d'un auteur"/>
        </form>
      <br/>
